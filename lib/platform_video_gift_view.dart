...
class PlatformVideoGiftView extends StatefulWidget {
  ...
  @override
  PlatformVideoGiftViewState createState() => PlatformVideoGiftViewState();
}

class PlatformVideoGiftViewState extends State<PlatformVideoGiftView> {
